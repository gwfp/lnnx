# Django settings for lnnx project.
...
STATIC_ROOT = STATIC_ROOT = os.path.join(PROJECT_ROOT, 'static').replace('\\','/')
...
SECRET_KEY = '%+kwy8@4zv=c6uykth%rj3yxhym3eza4n(&amp;365w5*ve@5+w)zb'
...
ROOT_URLCONF = 'lnnx.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lnnx.wsgi.application'
